...
public class GetOutputFilesVisitor extends PropertyVisitor.Adapter {
    ...
    public void visitOutputFileProperty(String propertyName, boolean optional, ValidatingValue value, OutputFilePropertyType filePropertyType) {
        ...
        if (filePropertyType == OutputFilePropertyType.DIRECTORIES || filePropertyType == OutputFilePropertyType.FILES) {
            Iterators.addAll(specs, resolveToFilePropertySpecs(ownerDisplayName, propertyName, value, filePropertyType.getOutputType(), fileResolver));
        } else {
    ...
    private static Iterator<OutputFilePropertySpec> resolveToFilePropertySpecs(final String ownerDisplayName, final String propertyName, ValidatingValue value, final TreeType outputType, final FileResolver resolver) {
