...
public class DefaultTaskOutputs implements TaskOutputsInternal {
    ...
    private final FilePropertyContainer<DeclaredTaskOutputFilePropertySpec> registeredFileProperties = FilePropertyContainer.create();
    ...
    public void visitRegisteredProperties(PropertyVisitor visitor) {
        for (DeclaredTaskOutputFilePropertySpec fileProperty : registeredFileProperties) {
    ...
    public TaskOutputFilePropertyBuilder file(final Object path) {
        return taskMutator.mutate("TaskOutputs.file(Object)", new Callable<TaskOutputFilePropertyBuilder>() {
            ...
            public TaskOutputFilePropertyBuilder call() {
                ...
                DeclaredTaskOutputFilePropertySpec outputFileSpec = createOutputFilePropertySpec(value, OutputFilePropertyType.FILE);
    ...
    public TaskOutputFilePropertyBuilder dir(final Object path) {
        return taskMutator.mutate("TaskOutputs.dir(Object)", new Callable<TaskOutputFilePropertyBuilder>() {
            ...
            public TaskOutputFilePropertyBuilder call() {
                StaticValue value = new StaticValue(path);
                value.attachProducer(task);
                DeclaredTaskOutputFilePropertySpec outputDirSpec = createOutputFilePropertySpec(value, OutputFilePropertyType.DIRECTORY);
    ...
    public TaskOutputFilePropertyBuilder files(final @Nullable Object... paths) {
        return taskMutator.mutate("TaskOutputs.files(Object...)", new Callable<TaskOutputFilePropertyBuilder>() {
            ...
            public TaskOutputFilePropertyBuilder call() {
                ...
                DeclaredTaskOutputFilePropertySpec outputFilesSpec = createOutputFilePropertySpec(value, OutputFilePropertyType.FILES);
    ...
    public TaskOutputFilePropertyBuilder dirs(final Object... paths) {
        return taskMutator.mutate("TaskOutputs.dirs(Object...)", new Callable<TaskOutputFilePropertyBuilder>() {
            ...
            public TaskOutputFilePropertyBuilder call() {
                StaticValue value = new StaticValue(resolveSingleArray(paths));
                DeclaredTaskOutputFilePropertySpec outputDirsSpec = createOutputFilePropertySpec(value, OutputFilePropertyType.DIRECTORIES);
    ...
    private DeclaredTaskOutputFilePropertySpec createOutputFilePropertySpec(ValidatingValue value, OutputFilePropertyType propertyType) {
        return new DefaultDeclaredTaskOutputFilePropertySpec(value, propertyType);
    }
