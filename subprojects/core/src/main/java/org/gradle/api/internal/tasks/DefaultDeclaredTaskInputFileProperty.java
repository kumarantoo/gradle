...
@NonNullApi
public class DefaultDeclaredTaskInputFileProperty implements DeclaredTaskInputFilePropertySpec {
    ...
    public DefaultDeclaredTaskInputFileProperty(ValidatingValue value, InputFilePropertyType filePropertyType) {
        this.value = value;
